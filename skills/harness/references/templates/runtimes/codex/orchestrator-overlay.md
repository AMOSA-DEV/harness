...
| 작업 추적 | `_workspace/machine/task-ledger.md` 또는 오케스트레이터 체크리스트를 사용한다 |
...
2. 각 역할의 산출물을 별도 `_workspace/machine/` 파일로 남긴다.
...
1. Phase 산출물을 목적에 맞게 `_workspace/audit/`, `_workspace/machine/`, `_workspace/human/` 아래에 저장한다.
